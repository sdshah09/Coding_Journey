'''
Shortest Job first
Difficulty: MediumAccuracy: 75.77%Submissions: 8K+Points: 4
...
https://www.youtube.com/watch?v=3-QbX1iDbXs&list=PLgUwDviBIf0rF1w2Koyh78zafB0cz7tea&index=3&ab_channel=takeUforward
'''
class Solution:
    def solve(self, bt):
        # Code here
