...
public class GenericTreeHeight {
    ...
    public static void main(String[] args) {
        ...
        int maxHeight = maximumHeight(root);
    ...
    private static int maximumHeight(Node root) {
        if(root == null) return 0;
        int maxHeight = 0;
        for(Node children: root.children) {
            maxHeight = Math.max(maxHeight, maximumHeight(children));
        }
        return 1 + maxHeight;
    }
